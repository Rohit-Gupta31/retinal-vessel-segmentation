...
path1 = '/teamspace/studios/this_studio/RetinalVesselSegmentation/retinalVesselData/train/image'  # training images directory 
path2 = '/teamspace/studios/this_studio/RetinalVesselSegmentation/retinalVesselData/train/mask'   # training masks directory
...
for i, mask_name in enumerate(masks):  
    if mask_name.endswith((".jpg", ".png", ".tif", ".gif")):                  
...
plt.ylabel('Loss')
plt.legend()
plt.savefig("loss_residualUnet2.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.legend()
plt.savefig("accuracy_Unet2.png", dpi=300, bbox_inches='tight')
plt.show()
...
plt.ylabel('IoU')
plt.legend()
plt.savefig("iou_plot_Unet.png", dpi=300, bbox_inches='tight')
plt.show()

# save model
model.save("retina_Unet_75epochs1.keras")
